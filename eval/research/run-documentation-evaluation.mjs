...
import { DocPilotStrategyProvider } from "./providers/doc-evaluation-provider.mjs";
import { evaluateFixture } from "./evaluate.mjs";
import fs from "node:fs";
import path from "node:path";

console.log("======================================================================");
console.log("  REPORISE SURFACE EVALUATION: P0 DOCS & MONOREPO HYPOTHESES");
console.log("======================================================================\n");

const provider = new DocPilotStrategyProvider();
const iterations = provider.candidates.length;

const runConfig = {
  campaign: "m8.6-larger-corpus-optimization",
  targetPriority: "P0_docs_monorepo_architecture",
...
async function main() {
  ...
  console.log(`Target: P0 Docs & Monorepo Depth (F08 / F03)`);
  ...
  const reportPath = path.resolve("docs/evaluation/data/documentation-evaluation.json");
